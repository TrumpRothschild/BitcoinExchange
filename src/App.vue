<template>
  <div :class="pageView">
            ...
            <div class="header_nav">
              <Menu :active-name="activeNav" width="auto" :open-names="['1']">
                <Submenu name="1">
                  ...
                  <router-link to="/swap" style="display: none;">
                  ...
                  <router-link to="/ctc" style="display: none;">
                  ...
                  <router-link to="/lab" style="position:relative;display:none;">
                  ...
                  <router-link to="/invite" style="display: none;">
              ...
              <Menu mode="horizontal" width="auto" @on-select="changelanguage" style="height: 50px;line-height:50px;">
                  <Submenu name="lang">
                      <template slot="title" class="lang-title">
                        ...
                        <!-- <img class="lang-img" v-if="lang=='GERMAN'" src="./assets/images/lang-de.png"></img> -->
                        <!-- <img class="lang-img" v-if="lang=='FRENCH'" src="./assets/images/lang-fr.png"></img> -->
                        <!-- <img class="lang-img" v-if="lang=='ITALIAN'" src="./assets/images/lang-it.png"></img> -->
                        <!-- <img class="lang-img" v-if="lang=='RUSSIAN'" src="./assets/images/lang-ru.png"></img> -->
                        <!-- <img class="lang-img" v-if="lang=='SPANISH'" src="./assets/images/lang-es.png"></img> -->
                        <img class="lang-img" v-if="lang=='KOREAN'" src="./assets/images/lang-ko.png"></img>
                        <img class="lang-img" v-if="lang=='JAPANESE'" src="./assets/images/lang-jp.png"></img>
                      </template>
                      <MenuItem name="zh" class="lang-item"><img src="./assets/images/lang-zh.png"></img><span class="titchina">简体中文</span></MenuItem>
                      <MenuItem name="en" class="lang-item"><img src="./assets/images/lang-en.png"></img><span class="titchina">ENGLISH</span></MenuItem>
                      <!-- <MenuItem name="de" class="lang-item"><img src="./assets/images/lang-de.png"></img><span class="titchina">GERMAN</span></MenuItem>
                      <MenuItem name="fr" class="lang-item"><img src="./assets/images/lang-fr.png"></img><span class="titchina">FRENCH</span></MenuItem>
                      <MenuItem name="it" class="lang-item"><img src="./assets/images/lang-it.png"></img><span class="titchina">ITALIAN</span></MenuItem>
                      <MenuItem name="ru" class="lang-item"><img src="./assets/images/lang-ru.png"></img><span class="titchina">RUSSIAN</span></MenuItem>
                      <MenuItem name="es" class="lang-item"><img src="./assets/images/lang-es.png"></img><span class="titchina">SPANISH</span></MenuItem> -->
                      <MenuItem name="ko" class="lang-item"><img src="./assets/images/lang-ko.png"></img><span class="titchina">KOREAN</span></MenuItem>
                      <MenuItem name="jp" class="lang-item"><img src="./assets/images/lang-jp.png"></img><span class="titchina">JAPANESE</span></MenuItem>
                  </Submenu>
              </Menu>
            </div>
    ...
    <Drawer :closable="true" width="45" v-model="navDrawerModal" class="header_nav_mobile">
        <Menu :active-name="activeNav" width="auto" @on-select="changelanguage">
            ...
            <MenuItem name="nav-ctc" style="text-align:left; display:none;" >{{$t("header.ctc")}}</MenuItem>
            <router-link to="/otc/trade/usdt" style="display:none;">
              <MenuItem name="nav-otc" style="text-align:left;">{{$t("header.otc")}}</MenuItem>
            </router-link>
            <router-link to="/lab">
              <MenuItem name="nav-lab" style="text-align:left;color:#bdc2ca;display:none;">{{$t("header.lab")}}</MenuItem>
            </router-link>
            <MenuItem name="nav-invite" style="text-align:left;display:none;">{{$t("header.invite")}}</MenuItem>
            <router-link to="/announcement/0">
              <MenuItem name="nav-service" style="text-align:left;color:#bdc2ca;">{{$t("header.service")}}</MenuItem>
            </router-link>
            <router-link to="/whitepaper">
              <MenuItem name="nav-whitepaper" style="text-align:left;display:none;">{{$t("header.whitepaper")}}</MenuItem>
            </router-link>
            ...
            <Submenu name="nav_personal" v-if="isLogin">
                ...
                <router-link to="/uc/entrust/current">
                  <MenuItem name="nav_innnovationmanage" class="lang-item" style="padding-left:20px!important;">{{$t("header.exchange")}}</MenuItem>
                </router-link>
            ...
            <Submenu name="lang">
                <template slot="title" class="lang-title">
                  <span style="color:#bdc2ca;">{{languageValue}}</span>
                      ...
                      <!-- <MenuItem name="de" class="lang-item"><img src="./assets/images/lang-en.png"></img>GERMAN</MenuItem> -->
                      <!-- <MenuItem name="fr" class="lang-item"><img src="./assets/images/lang-en.png"></img>FRENCH</MenuItem> -->
                      <!-- <MenuItem name="it" class="lang-item"><img src="./assets/images/lang-en.png"></img>ITALIAN</MenuItem> -->
                      <!-- <MenuItem name="ru" class="lang-item"><img src="./assets/images/lang-en.png"></img>RUSSIAN</MenuItem> -->
                      <!-- <MenuItem name="es" class="lang-item"><img src="./assets/images/lang-en.png"></img>SPANISH</MenuItem> -->
                      <MenuItem name="ko" class="lang-item"><img src="./assets/images/lang-ko.png"></img>KOREAN</MenuItem>
                      <MenuItem name="jp" class="lang-item"><img src="./assets/images/lang-jp.png"></img>JAPANESE</MenuItem>
    ...
    <div :class="this.$store.state.ismobile?'footerMoblie':'footer'">
      <div class="footer_content">
        <div class="mfootli" :style="{display:this.$store.state.ismobile?'block':'none'}">
        <div class="links-m">
          <ul>
             ...
             <li class="footer_title">
                ...
                <li class="wechatclick">
                  <poptip width="200" trigger="hover" placement="right">
                    ...
                    <div slot="content">
                      <p style="text-align:center;">support@cbdcoincurrency.com</p>
                    </div>
                  </poptip>
                </li>
                <li class="wechatclick">
        ...
        <div class="footer_left">
          ...
          <p>Copyright © 2021 - cbdcoincurrency.com</p>
          ...
          <!-- <div class="social-list">
            <ul>
              ...
              <Tooltip content="https://weibo.com/cbdcoincurrency" theme="dark" placement="top">
                <li>
                  <Icon custom="i-icon iconfont iconweibo" />
                </li>
              </Tooltip>
              <Tooltip content="https://twitter.com/cbdcoincurrency" theme="dark" placement="top">
                <li>
                  <Icon type="logo-twitter" />
                </li>
              </Tooltip>
              <Tooltip content="https://medium.com/@cbdcoincurrency" theme="dark" placement="top">
                <li>
                  <Icon custom="i-icon iconfont iconmedium" />
                </li>
              </Tooltip>
              <Tooltip content="https://www.reddit.com/u/cbdcoincurrency" theme="dark" placement="top">
                <li>
        ...
        <div class="footer_right" style="margin-left: 3%;border-left: 1px solid #243051;padding-left: 3%;">
          <ul>
            <li class="footer_title">
              <span>{{$t("footer.yqlj")}}</span>
            </li>
...
export default {
  ...
  watch: {
    activeNav: function() {
      switch (this.activeNav) {
        case "nav-exchange":
          window.document.title = (this.lang == "简体中文" ? "交易中心" : "Exchange") + " - cbdcoincurrency | cbdcoincurrency offical website - global currency trading platform | global digital currency trading platform";
          break;
        case "nav-service":
          window.document.title = (this.lang == "简体中文" ? "公告" : "Announcement") + " - cbdcoincurrency | cbdcoincurrency offical website - global currency trading platform | global digital currency trading platform";
          break;
        case "nav-about":
          window.document.title = (this.lang == "简体中文" ? "关于" : "About") + " - cbdcoincurrency | cbdcoincurrency offical website - global currency trading platform | global digital currency trading platform";
          break;
        case "nav-lab":
          window.document.title = (this.lang == "简体中文" ? "创新实验室" : "Lab") + " - cbdcoincurrency | cbdcoincurrency offical website - global currency trading platform | global digital currency trading platform";
          break;
        case "nav-invite":
          window.document.title = (this.lang == "简体中文" ? "推广合伙人" : "Promotion") + " - cbdcoincurrency | cbdcoincurrency offical website - global currency trading platform | global digital currency trading platform";
          break;
	      case "nav-cexchange":
          window.document.title = (this.lang == "简体中文" ? "活动" : "Activity") + " - cbdcoincurrency | cbdcoincurrency offical website - global currency trading platform | global digital currency trading platform";
          break;
        default:
          window.document.title = "cbdcoincurrency | cbdcoincurrency offical website - global currency trading platform | global digital currency trading platform";
          break;
      }
    },
    $route(to, from) {
  ...
  computed: {
    ...
    languageValue: function() {
      ...
      else if (curlang == "简体中文") this.$i18n.locale = "zh";
      // else if (curlang == "GERMAN") this.$i18n.locale = "de";
      // else if (curlang == "SPANISH") this.$i18n.locale = "es";
      // else if (curlang == "FRENCH") this.$i18n.locale = "fr";
      // else if (curlang == "ITALIAN") this.$i18n.locale = "it";
      else if (curlang == "JAPANESE") this.$i18n.locale = "jp";
      else if (curlang == "KOREAN") this.$i18n.locale = "ko";
      //else if (curlang == "RUSSIAN") this.$i18n.locale = "ru";
  ...
  created: function() {
    ...
    //判断设备
     if(!!this.isMobile()) this.$store.commit("checkmobile", true);
  },
  methods: {
    reload () {
...
　    　let flag = navigator.userAgent.match(/(phone|pad|pod|iPhone|iPod|ios|iPad|Android|Mobile|BlackBerry|IEMobile|MQQBrowser|JUC|Fennec|wOSBrowser|BrowserNG|WebOS|Symbian|Windows Phone)/i)
    ...
    changelanguage: function(name) {
      ...
      // else if (name == "de") {
      //   this.$store.commit("setlang", "GERMAN");
      //   this.$i18n.locale = "de";
      //   this.reload();
      // }else if (name == "es") {
      //   this.$store.commit("setlang", "SPANISH");
      //   this.$i18n.locale = "es";
      //   this.reload();
      // }else if (name == "fr") {
      //   this.$store.commit("setlang", "FRENCH");
      //   this.$i18n.locale = "fr";
      //   this.reload();
      // }else if (name == "it") {
      //   this.$store.commit("setlang", "ITALIAN");
      //   this.$i18n.locale = "it";
      //   this.reload();
      // }
      else if (name == "jp") {
        this.$store.commit("setlang", "JAPANESE");
        this.$i18n.locale = "jp";
        this.reload();
      }
      else if (name == "ko") {
        this.$store.commit("setlang", "KOREAN");
        this.$i18n.locale = "ko";
        this.reload();
      }
      // else if (name == "ru") {
      //   this.$store.commit("setlang", "RUSSIAN");
      //   this.$i18n.locale = "ru";
      //   this.reload();
      // }
    }
...
@media screen and (max-width:768px){
  .footerMoblie .footer_left img{
    height: auto !important;
    width: 80% !important;
  }
  .footerMoblie .footer_left p{
...
.friend-link-m ul li:nth-child(1){
  width:100%;
  padding-bottom:2%;
  padding-top:3%;
  border-top: 1px solid #142028;
  font-size: 13px;
}
.links-m ul{
  float:left;
...
.links-m ul:nth-child(4){
  margin-right:0;
}
.links-m .footer_title,.friend-link-m ul{
  padding-bottom:4%;
  height:auto;
}

.links-m a,.friend-link-m ul li a{
...
.mivu-input .ivu-input,.mivu-input .ivu-input-icon{
...
@media screen and (max-width:768px){
  .footer_content,html, body{
      background: #09171F!important;
  }
