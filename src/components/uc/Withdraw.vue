  ...
  <div class="nav-rights withdraw">
    <div class="nav-right">
      <div class="rightarea">
        ...
        <section>
          <div :class='["action-box",this.$store.state.ismobile?"tableMoblie":"table-inner"]'> 
            ...
            <div class="form-group-container">
              ...
              <div class="form-group form-amount" v-else>
    ...
    <Modal v-model="modal" width="450">
      ...
      <Form class="withdraw-form-inline" ref="formInline" :model="formInline" inline>
        ...
        <FormItem prop="code">
          ...
          <input id="sendCode" @click="sendCode();" type="Button" :value="sendcodeValue" :disabled="codeIsSending"></input>
        </FormItem>
        <FormItem>
...
@media screen and (max-width:768px){
 .merchantTobMoblie{
  ...
  .tableMoblie .action-foot button{
    line-height: 32px!important;
    height:32px!important;
    margin:0!important;
    padding:0!important;
