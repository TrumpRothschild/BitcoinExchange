      ...
      <div class="bill_box rightarea padding-right-clear">
        <div class="shaow">
          <div class="money_table">
            <div style="width: 100%;height: 50px;" class="filterbox">
              <div style="float:left;letter-spacing:1px;padding-top: 5px;" class="filterdata">
                  <span style="font-size:12px;color:#828ea1;">{{$t('uc.finance.money.totalassets')}}</span>
                  <span class="gold" style="font-size: 18px;color:#D8E1EB;">${{totalUSDT}}</span>
              ...
              <Button @click="toQuickExchange" type="warning" style="padding: 6px 30px;margin-right:30px;background-color:#f0a70a;border-color:#f0a70a;float:right;display:none;">{{$t('uc.finance.record.quickExchange')}}</Button>
            </div>
            <div class="mtabile">
...
@media screen and (max-width:768px){
  ...
  .nav-right .rightarea.bill_box .shaow{
    padding:10px 15px;
  ...
  .search{
    ...
    border-top:1px solid #1f2a35!important;
  }
