                    ...
                    <div class="account-in">
                        ...
                        <div class="account-item">
                            ...
                            <div class="account-detail" v-show="choseItem==3">
                                <div class="detail-list" style="width:70%;">
                                    <Form ref="formValidate3" class="account-phone-bind" :model="formValidate3" :rules="ruleValidate" :label-width="200">
                                        <!-- 手机 -->
                                        <FormItem :label="$t('uc.safe.phone')" prop="mobile">
                                          <Input type="text" v-model="formValidate3.mobile" size="large">
                                          <select v-model="formValidate3.country" slot="prepend" style="width: 60px;" class="countryselect">
                                            <option value="America" label="1"><span>+1</span><span style="margin-left:10px;color:#ccc">America</span></option>
                                            <option value="Morocco" label="212"><span>+212</span><span style="margin-left:10px;color:#ccc">Morocco</span></option>
                                            <option value="Nigeria" label="234"><span>+234</span><span style="margin-left:10px;color:#ccc">Nigeria</span></option>
                                            <option value="Greece" label="30"><span>+30</span><span style="margin-left:10px;color:#ccc">Greece</span></option>
                                            <option value="Netherlands" label="31"><span>+31</span><span style="margin-left:10px;color:#ccc">Netherlands</span></option>
                                            <option value="France" label="33"><span>+33</span><span style="margin-left:10px;color:#ccc">France</span></option>
                                            <option value="Spain" label="34"><span>+34</span><span style="margin-left:10px;color:#ccc">Spain</span></option>
                                            <option value="Portugal" label="351"><span>+351</span><span style="margin-left:10px;color:#ccc">Portugal</span></option>
                                            <option value="Ireland" label="353"><span>+353</span><span style="margin-left:10px;color:#ccc">Ireland</span></option>
                                            <option value="Hungary" label="36"><span>+36</span><span style="margin-left:10px;color:#ccc">Hungary</span></option>
                                            <option value="Belarus" label="375"><span>+375</span><span style="margin-left:10px;color:#ccc">Belarus</span></option>
                                            <option value="Ukraine" label="380"><span>+380</span><span style="margin-left:10px;color:#ccc">Ukraine</span></option>
                                            <option value="Italy" label="39"><span>+39</span><span style="margin-left:10px;color:#ccc">Italy</span></option>
                                            <option value="Romania" label="40"><span>+40</span><span style="margin-left:10px;color:#ccc">Romania</span></option>
                                            <option value="Swiss" label="41"><span>+41</span><span style="margin-left:10px;color:#ccc">Swiss</span></option>
                                            <option value="Czech" label="420"><span>+420</span><span style="margin-left:10px;color:#ccc">Czech</span></option>
                                            <option value="Slovakia" label="421"><span>+421</span><span style="margin-left:10px;color:#ccc">Slovakia</span></option>
                                            <option value="Austria" label="43"><span>+43</span><span style="margin-left:10px;color:#ccc">Austria</span></option>
                                            <option value="UK" label="44"><span>+44</span><span style="margin-left:10px;color:#ccc">UK</span></option>
                                            <option value="Poland" label="48"><span>+48</span><span style="margin-left:10px;color:#ccc">Poland</span></option>
                                            <option value="Germany" label="49"><span>+49</span><span style="margin-left:10px;color:#ccc">Germany</span></option>
                                            <option value="Mexico" label="52"><span>+52</span><span style="margin-left:10px;color:#ccc">Mexico</span></option>
                                            <option value="Malaysia" label="60"><span>+60</span><span style="margin-left:10px;color:#ccc">Malaysia</span></option>
                                            <option value="Indonesia" label="62"><span>+62</span><span style="margin-left:10px;color:#ccc">Indonesia</span></option>
                                            ...
                                            <option value="Korea" label="82"><span>+82</span><span style="margin-left:10px;color:#ccc">Korea</span></option>
                                            ...
                                            <option value="Hongkong" label="852"><span>+852</span><span style="margin-left:10px;color:#ccc">Hongkong, China</span></option>
                                            <option value="Taiwan" label="886"><span>+886</span><span style="margin-left:10px;color:#ccc">Taiwan, China</span></option>
                                            ...
                                            <option value="Pakistan" label="92"><span>+92</span><span style="margin-left:10px;color:#ccc">Pakistan</span></option>
                                            <option value="Iran" label="98"><span>+98</span><span style="margin-left:10px;color:#ccc">Iran</span></option>
                                          </select>
                                        </Input>
                                      </FormItem>
                        ...
                        <div class="account-item">
                            ...
                            <div class="account-detail" v-show="choseItem==4">
                                <div class="detail-list">
                                    <Form ref="formValidate4" :model="formValidate4" :rules="ruleValidate">
                                        <!-- oldPw -->
                        ...
                        <div class="account-item">
                            ...
                            <div class="account-detail" v-show="choseItem==5">
                                ...
                                <div class="detail-list" v-show="user.fundsVerified==1  && !fGetBackFundpwd">
                                    <Form ref="formValidate5" :model="formValidate5" :rules="ruleValidate">
                                        <!-- oldPw -->
  ...
  methods: {
    beforeUpload(data) {
      if (data && data.size >= 1024000 * 2) {
        this.$Message.error(this.$t("common.uploadsize"));
        return false;
      }
    },
...
<style scoped lang="scss">
  ...
  .account-phone-bind >>> .ivu-form .ivu-form-item-label{
      text-align: left !important;
  }
  >>> .account-phone-bind label.ivu-form-item-label {
      text-align: left;
  }
 @media screen and (max-width:768px){
    
    .mymsg_wrapper .wrapper .nav-right{
...
.account-box .account-in .account-item .account-item-in span,.account-box .account-in .account-item .account-item-in a{
  margin-left:auto;
}
