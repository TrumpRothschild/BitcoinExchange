...
<template>
  <div class="mymsg_wrapper">
        ...
        <Col :xs="24" :sm="24" :md="4" :lg="4">
          ...
          <Menu class="pc_menu" :active-name="activename" :open-names="opennames" @on-open-change="sss" ref="test" :accordion="true" style="width:100%;">
            ...
            <Submenu name="1">
              ...
              <MenuItem name="1-2" style="display:none;">
            ...
            <Submenu name="2">
              ...
              <MenuItem name="2-10" style="display:none;">
              ...
              <MenuItem name="2-9" style="display:none;">
            ...
            <Submenu name="5">
              ...
              <MenuItem name="5-2">
              <router-link to="/uc/promotion/mycards" style="display:none;">{{$t('uc.promotion.subtitle1')}}</router-link>
              </MenuItem>
            </Submenu>
            <Submenu name="6" style="display:none;">
              <template slot="title">
                <span class="isclick"></span>
            ...
            <Submenu name="7" style="display:none;">
                <template slot="title">
                    <span class="isclick"></span>
    ...
    <Drawer :closable="true" width="42" v-model="ucNavDrawerModal" class="header_nav_mobile uc_header_nav">
      <Menu :active-name="activename" :open-names="opennames" @on-open-change="sss" ref="test" :accordion="true" placement="left" width="auto">
            ...
            <Submenu name="5" >
              ...
              <MenuItem name="5-2" style="display:none;">
