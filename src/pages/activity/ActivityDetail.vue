  ...
  methods: {
    ...
    getData(){
        ...
        if (res.status == 200 && res.body.code == 0) {
            ...
            window.document.title = (this.lang == "简体中文" ? "活动 - " : "Activity - ") + this.activityDetail.title + " - cbdcoincurrency | cbdcoincurrency offical website - global currency trading platform | global digital currency trading platform";
            //持仓瓜分类型进度显示处理
