  ...
  <div class="invite">
      ...
      <div class="promotion-tools">
        ...
        <div class="tools">
          <div class="item" @click="showCardItem">
              <img src="https://modcurrency.oss-accelerate.aliyuncs.com/2021/promotioncard.png"></img>
          ...
          <div class="item" @click="useInviteImage">
              <img src="https://modcurrency.oss-accelerate.aliyuncs.com/2021/invitebg.jpg"></img>
    ...
    <Drawer :title="$t('invite.pt_title')" :closable="false" v-model="showCardModal" width="600">
      <div class="ptcard-header">
        <img class="card-img" src="https://modcurrency.oss-accelerate.aliyuncs.com/2021/promotioncard.png"></img>
        <div class="desc">
      ...
      <div class="ptcard-info">
        ...
        <p class="detail">{{$t('invite.pt_card_rule1')}}: support@cbdcoincurrency.com。</p>
  ...
  data() {
    ...
    return {
      ...
      myInfo: {
        ...
        extrareward: 0,
        partnerlevel: "-",
        inviteLink: "https://www.cbdcoincurrency.com/register?code=000000"
      },
      promotionRecordPage: {
        pageNo: 1,
        pageSize: 10
