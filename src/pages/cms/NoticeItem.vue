<template>
  <div class="notice">
    ...
    <div class="bottom-list">
      <p style="font-size: 18px;margin: 15px 0;" class="pcnew">最新公告</p>
      ...
      this.$http
        ...
        .then(response => {
          ...
          if (result.code == 0) {
            ...
            window.document.title = (this.lang == "简体中文" ? "公告 - " : "Announcement - ") + this.data.info.title + " - cbdcoincurrency | cbdcoincurrency offical website - global currency trading platform | global digital currency trading platform";
          }else{
...
@media screen and (max-width:768px){
  ...
  .notice .content-wrap .header{
    padding: 6% 0!important;
    text-align: left!important;
    margin: 0!important;
    border-color: #1f2a35!important;
  }

   .notice .content-wrap .header span{
      padding: 0!important;
