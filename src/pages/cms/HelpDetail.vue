    ...
    init() {
      Promise.all([this.getTop(), this.getArticle()]).then(arr => {
        if (
          ...
          window.document.title = (this.lang == "简体中文" ? "帮助 - " : "Help - ") + this.article.title + " - cbdcoincurrency | cbdcoincurrency offical website - global currency trading platform | global digital currency trading platform";
        } else {
...
@media screen and (max-width:768px){
  .page-view .helpdetail {
    background: none!important;
  }
  .helpdetail .content-wrap{
 ...
 .main .content-wrap .title{
   ...
   .helpdetail .content-wrap .header span{
      padding: 0!important;
