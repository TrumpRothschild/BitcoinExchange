module.exports = {
    common: {
        ...
        sitedesc: " | Global bitcoin trading platform global digital currency trading platform",
        official: "Official",
        login: 'Log In',
        register: 'Sign Up',
        ...
        ok: "OK",
        or: "Or",
        welcome1: "Welcome to cbdcoincurrency.com",
        welcome2: "Buy & Sell Crypto in minutes",
    ...
    sectionPage: {
        ...
        brandTitle: "About cbdcoincurrency",
        brandDetail: "Honest  |  Fair  |  Enthusiasm  |  Open",
        brandDesc1: "cbdcoincurrency was founded by a group of early Bitcoin participants and geeks. The core members of the team are from well-known enterprises such as Google, Microsoft, Alibaba, Tencent and so on. It has deep research and development strength and rich experience in Internet product operation.",
        brandDesc2: "cbdcoincurrency is located in the basic service provider of block chain, dedicated to providing high-quality encrypted assets trading platform for global users, adhering to the basic principle of “DO NOT BE EVIL”, upholding honest, fair and enthusiastic service to customers, and welcoming all partners/projects that are beneficial to the fundamental interests of users with an open attitude.",
        gettingstart: "HOT | Beginner's Guide",
        officialstart: "cbdcoincurrency Official Customer Service",
        oneminutebuy: "Fiat Currency",
        oneminutebuytips: "Trade crypto with legal currency.",
        baseknow: "Basics of Blockchain",
        baseknowtips: "Basics of blockchain、bitcoin etc.",
        baseexchange: "How To Exchange",
        baseexchangetips: "How to buy and sell on exchange.",
        ...
        infotip1: "Ease of Trading",
        infotip1_1: "Intuitive interface",
        infotip1_2: "Instant deposit options",
        infotip1_3: "Cash out directly to your bank account",
        infotip2: "Institutional-grade Security",
        infotip2_1: "98% of assets stored safely offline",
        infotip2_2: "Highly encrypted personal data",
        infotip2_3: "Whitelisting and transaction confirmations",
        infotip3: "Proven Reliability",
        infotip3_1: "Exchanging bitcoin since 2018",
        infotip3_2: "24/7 dedicated support",
        infotip3_3: "Industry-leading uptime",
        infotip4: "Fair and Transparent",
        infotip4_1: "Clear capital rate",
        infotip4_2: "Transparent trading rules",
        infotip4_3: "Fair price index",
        infotip4_4: "Accurate profit and loss calculation",
        registernow: "Register Now",
        tradenow: "Go Trading",
        newguider: "Novice Tutorial",
        newguiderdesc: "Open digital currency transaction learning immediately",
        apptext: "Trade. Anywhere.",
        appdesc: "Whether it is app or web, you can quickly open your transaction",
        codedown: "Download",
        steptitle: "Start Trading",
        stepdesc: "Enter a new field of investment",
        step1: "Download App",
        step2: "Registration",
        ...
        blockdesc: "Quick query transaction on block-chain"
    },
    nav: {
    ...
    market: {
        markets: "Markets",
        custom: "Favorites",
        spotmarket: "Spot Markets",
        futuremarket: "Futures Markets",
        turnover: "Turnover",
        volume: "Volume",
        overview: "Markets Overview",
        updown: "Price Change Distribution",
        up: "Price up",
        down: "Price down",
        symbol: "Coin Pair",
        close: "Last Price",
        turnoverRank: "Turnover Ranking",
        ...
        sulkt3: "Neutral",
        sulkt4: "Greed",
        sulkt5: "Extreme Greed",
        sulktip: "Extreme fear indicates that investors are too worried and may be a buying opportunity. Too greedy indicates that investors are too excited and the market may adjust."
    },
    exchange: {
        coin: 'Coin',
        symbol:'Transaction pair',
    ...
    option: {
        ...
        buyupreward: "Buy Pool",
        buydownreward: "Sell Pool",
        quantity: "Bet Amount",
        myamount: "My Bet",
        buyup: "Price Up",
        buydown: "Price Down",
    ...
    otc: {
        ...
        certifiedTitle: "Tips",
        certifiedTip: "You need to apply for and get permission to publish the advertisement first.",
        apply: "Apply",
        zixuanqu: "P2P",
        kuaijiequ: "Express",
        zixuantip1: "Custom transaction",
        zixuantip2: "More options & free trading",
        limit: "Limit",
        price: "Price",
        myad: {
            title: 'My Ad',
    ...
    activity: {
        ...
        attentiontxt4: "* The right of final interpretation of this activity belongs to the official ownership of cbdcoincurrency.",
        ...
        submit: "Submit",
        tipsmobile: "Please use PC web（www.mobtc.com）",
    ...
    invite: {
        ...
        ruleprofile1:"[Promotion Partner] is the highest proportion of online Commission return and the longest time of commission return (maximum lifetime commission). Promoters who make corresponding efforts can become real platform ‘partners’ and enjoy the dividend of growing together with cbdcoincurrency trading platform. Detailed rules are as follows:",
        ruleprofile2:"",
        ruleprofile3:"",
        ruleprofile4:"",
        ruletext1: "1、In order to preach the concept of digital assets and expand the scale of users, cbdcoincurrency launched the “Promotion Partner” program, which is effective for a long time.",
        ...
        ruletext11: "11、The right of final interpretation of this activity belongs to cbdcoincurrency.",
        ...
        thanks: "Thank you for supporting cbdcoincurrency!",
        ...
        pt_tips: "If you have a good idea, please send an email to promotion@mobtc.com, with a reward after adoption.！",
        ...
        pt_card_rule6: "6. The right of final interpretation of free gift cards belongs to mobtc.com.",
        pt_card_day: "Days",
    ...
    uc: {
        appdownload: {
            download: "Download",
            lastedversion: "Lasted Version",
            versiondate: "Deploy Date",
            tiptitle1: "Ultimate Experience",
            tipdesc1: "Carefully optimized interface display, experience smooth operation response",
            tiptitle2: "Currency Market",
            tipdesc2: "Support MACD, KDJ, RSI, boll and other professional indicators",
            tiptitle3: "Currency Transaction",
            tipdesc3: "Supports limit order and market order",
            tiptitle4: "Legal currency transaction",
            tipdesc4: "High quality acceptor to ensure smooth capital channel",
            tiptitle5: "Asset Center",
            tipdesc5: "Pay attention to asset changes anytime and anywhere, recharge / withdraw quickly",
        },
        ...
        regist: {
            ...
            promotion: 'Invite Code',
            promotiontip:"Enter promotion code"
        },
        safe: {
        ...
        identity: {
            ...
            become: "Become cbdcoincurrency Certified Business and enjoy more transaction privileges",
    ...
    cms: {
        ...
        download: "Download",
        downloadslogan: "cbdcoincurrency APP - Trade everywhere."
    },
    description: {
        title1: 'Security',
        title2: '24H Service',
        ...
        aboutdesc1: "cbdcoincurrency is a leading digital asset trading platform in the world, registered in the Cayman Islands, with a core operating team in Hong Kong. The core members of mobtc.com come from top Internet and financial companies. Most of them are deep believers in Bitcoin and block chains. We are convinced that block chains will change the traditional monopolistic financial system and build a more democratic and autonomous social structure.",
        aboutdesc2: "cbdcoincurrency platform has a professional financial-level trading architecture, a self-developed high concurrent memory matching trading engine. The platform uses a full-cold rechargeable wallet system + multiple signatures + high-protection DDOS attack system and other trading architecture to ensure customer asset security.",
        aboutdesc3: "In order to let customers better grasp the investment opportunities, cbdcoincurrency adopts flat management in customer service department, and establishes an extremely fast service response mechanism. The asset customer service manager is on-line 7*24H all the year round, providing customers with services such as recharge and cash of assets, and ensuring that customers complete recharge in 25 minutes.",
        aboutdesc4: "cbdcoincurrency strictly screens high-quality projects and provides secure and stable asset hosting services. cbdcoincurrency upholds the concept of “honesty, justice, enthusiasm and openness”, and strives to create a safe, reliable, efficient and friendly ultimate exchange for users.",
        ...
        apply: "Board Apply",
        coop: "Cooperation",
        community: "cbdcoincurrency Community",
        wechat: "Wechat",
        addwechat: "Add 'cbdcoincurrency01' as Wechat friends and then enter Wechat community",
        weibo: "Weibo",
        twitter: "Twitter",
        biyong: "Biyong",
        telegram: "Telegram",
    ...
    index: {
        ...
        BHBregister: "cbdcoincurrency account registration",
        ...
        fenpeijizhi: 'A description of the cbdcoincurrency income distribution mechanism',
    ...
    plate: {
        ...
        content1: "As described in the white paper, cbdcoincurrency will take up 80% of the platform (after deduct Taxes and fees )The income is allocated to BHB holders, and 20% of revenue is used to support R & D and operation of the platform.",
