module.exports = {
    common: {
        uploadsize:"上传图片大小不能超过10M",
        site: "cbdcoincurrency",
        sitedesc: " | 全球比特币交易平台 | 全球数字货币交易平台",
        official: "官网",
        login: '登录',
        register: '注册',
        loginregister: "登录/注册",
    ...
    sectionPage: {
        ...
        newsTitle: '多终端APP',
        brandTitle: "关于cbdcoincurrency",
        brandDetail: "诚实 | 公平 | 热情 | 开放",
        brandDesc1: "cbdcoincurrency由一群比特币早期参与者与极客创立，团队核心成员来自于谷歌、微软、阿里巴巴、腾讯等知名企业，具有深厚的研发实力与丰富的互联网产品运营经验。",
        brandDesc2: "cbdcoincurrency定位于区块链基础服务商，致力于为全球用户提供优质加密资产交易平台，秉承着“不作恶”的基本原则，坚持诚实、公正、热情的服务于客户，以开放的态度迎接一切有利于用户根本利益的伙伴/项目。",
        gettingstart: "新手入门 | 极速买币",
        officialstart: "cbdcoincurrency新手入门辅助通道",
        oneminutebuy: "法币通道",
        oneminutebuytips: "如何用法币买卖比特币等",
        baseknow: "区块链基础",
        ...
        infotip1_3: "全方位的交易终端",
        infotip2: "金融级安全",
        infotip2_1: "冷热隔离存储用户资产",
        infotip2_2: "高度加密的个人数据",
        infotip2_3: "白名单和交易确认",
        infotip3: "稳定可靠",
        infotip3_1: "自2018年开始交换比特币",
        infotip3_2: "24/7全天候支持",
        infotip3_3: "业界领先的撮合引擎",
        infotip4: "公正透明",
        infotip4_1: "明确的资金费率",
        infotip4_2: "透明的交易规则",
        infotip4_3: "公平的价格指数",
        ...
        tradenow: "立即交易",
        newguider: "新手指南",
        newguiderdesc: "即刻开启数字货币交易学习",
        apptext: "随时随地开启交易",
        appdesc: "无论是APP还是WEB，都可以快速开启您的交易",
        codedown: "扫码下载",
        steptitle: "现在开始",
        stepdesc: "进入一个全新的投资领域",
        step1: "下载APP",
        step2: "平台注册",
        step3: "实名认证",
        step4: "充值入金",
    ...
    market: {
        ...
        sulkt4: "贪婪",
        sulkt5: "极度贪婪",
        sulktip: "极度恐惧表明投资者过于担心，可能是一个买入机会。过于贪婪表明投资者过于兴奋，市场可能会进行调整。"
    },
    exchange: {
        coin: '币种',
        symbol:"交易对",
    ...
    ctc: {
        title: "平台托管",
        desc:"由cbdcoincurrency平台托管数字资产，保障用户资产安全",
        buyin: "买入",
        sell: "卖出",
        buyprice: "买入价",
        sellprice: "卖出价",
    ...
    otc: {
        ...
        certifiedTitle: "提示",
        certifiedTip: "您需要先申请并获得广告发布权限",
        apply: "申请",
        zixuanqu: "自选区",
        kuaijiequ: "快捷区",
        zixuantip1: "自选交易",
        zixuantip2: "更多选择，自由交易",
        limit: "限额",
        price: "单价",
        myad: {
            title: '我的广告',
    ...
    activity: {
        ...
        attentiontxt4: "* 本活动最终解释权归cbdcoincurrency(cbdcoincurrency)官方所有",
        inputamount: "输入兑换数量",
        ...
        submit: "提交",
        tipsmobile: "请进入电脑端页面参与（www.mobtc.com）",
        tipsmobile1: "请在电脑端打开（www.mobtc.com）并进入创新实验区参与",
        intvalue: "请输入整数",
    ...
    invite: {
        ...
        partnerlevel: "合伙级别",
        ruledetail: "规则详情",
        ruleprofile1:"cbdcoincurrency(cbdcoincurrency)的【推广合伙人】是全网",
        ruleprofile2:"返佣比例最高、",
        ruleprofile3:"返佣时长最长(最高终身返佣)",
        ruleprofile4:"的推广活动，让付出相应努力的推广者能够成为真正意义上的平台“合伙人”，享受与cbdcoincurrency(cbdcoincurrency)交易平台共同成长的红利！具体细则如下：",
        ruletext1: "一、为布道数字资产理念与扩大用户规模，cbdcoincurrency(cbdcoincurrency)推出【推广合伙人】计划，该活动长期有效。",
        ...
        ruletext8: "八、推广返佣排行榜TOP10或TOP100不定期会获得由cbdcoincurrency(cbdcoincurrency)官方发放的额外奖励。",
        ruletext9: "九、如其他活动与【推广合伙人】活动冲突，则经协商后决定是否临时变更，望诸合伙人谅解。",
        ruletext10: "十、L4(巡抚)、L5(太守)、L6(节度使)级合伙人分别享受每年返佣总额的5%、10%、15%的分红奖励。",
        ruletext11: "十一、本活动最终解释权归cbdcoincurrency(cbdcoincurrency)所有。",
        ...
        thanks: "感谢您陪着cbdcoincurrency(cbdcoincurrency)一起成长！",
        headertip: "以上佣金数据非实时更新，系统每24H统计并更新一次。",
        ptools: "推广工具箱",
        pt_title: "数字货币礼品卡",
        pt_desc: "兑换后自动成为下级好友，送朋友、送亲人、送客户、送伙伴。助力推广合伙人更好推广。",
        pt_more: "更多工具，敬请期待",
        pt_tips: "如果您有好的创意，请发送邮件至promotion@mobtc.com，采纳后有奖励哦！",
        pt_card_amount: "卡面金额",
        ...
        pt_card_rule2: "二、免费礼品卡每个用户限兑1份。由cbdcoincurrency(cbdcoincurrency)官方发放的免费礼品卡，每个用户限兑一份，即使通过不同用户领取到不同兑换码的免费礼品卡，也只能兑换1份。自定义制作礼品卡不受此限制。",
        ...
        pt_card_rule6: "六、免费礼品卡最终解释权归mobtc.com所有。",
        pt_card_day: "天",
    ...
    uc: {
        appdownload: {
            ...
            versiondate: "发布时间",
            tiptitle1: "极致体验",
            tipdesc1: "精心优化的界面显示，体验流畅的操作响应",
            tiptitle2: "币种行情",
            tipdesc2: "支持MACD、KDJ、RSI、BOLL等多种专业指标",
            tiptitle3: "币币交易",
            tipdesc3: "支持限价委托与市价委托两种方式",
            tiptitle4: "法币交易",
            tipdesc4: "优质承兑商，保证资金通道顺畅无阻",
            tiptitle5: "资产中心",
            tipdesc5: "随时随地关注资产变化，极速充值/提现"
        },
        verify: "实名认证",
        login: {
            noaccount: '没有账号？',
        ...
        identity: {
            ...
            placeholder: "请填写取消原因",
            apply: '申请成为商家',
            become: '成为cbdcoincurrency认证商家， 享更多交易特权',
    ...
    cms: {
        ...
        scanforshare: "扫一扫分享",
        download: "立即下载",
        downloadslogan: "cbdcoincurrency APP - 全球数字资产交易平台"
    },
    description: {
        // message1: 'SSL、动态身份验证等银行级别安全技术，\n保障交易安全；支持多种数字货币交易',
        // message2: '严格的项目准入门槛，确保平台用户利益；\n100%保证金，钱包冷热隔离，确保用户资金安全',
        // message3: 'cbdcoincurrency数字资产交易平台支持每秒1000笔交易，给用户带来酣畅淋漓\n的交易体验',
        title1: '金融级安全',
        title2: '极速充提',
        title3: '全球服务',
        title4: '严选资产',
        ...
        message5: 'cbdcoincurrency(cbdcoincurrency)国际数字加密资产交易平台手机客户端，专注掌上交易体验',
        scanqrcode: "扫描二维码，下载APP",
        aboutdesc1: "cbdcoincurrency(cbdcoincurrency)是技术全球领先的数字资产交易平台，注册于开曼群岛，核心运营团队位于香港。cbdcoincurrency(cbdcoincurrency)核心成员来自于顶级互联网和金融公司，大部分成员是深度比特币和区块链信仰者，我们深信区块链将改变传统垄断性金融体系，会建立一个更加民主、自治的社会结构。",
        aboutdesc2: "cbdcoincurrency(cbdcoincurrency)平台拥有专业金融级别的交易架构，拥有自主研发的高并发内存撮合交易引擎，平台采用全冷充值钱包系统+多重签名+高防护DDOS攻击系统等交易架构，保证客户资产安全。",
        aboutdesc3: "cbdcoincurrency(cbdcoincurrency)为了让客户更好的把握投资机会，客服部门内部采用扁平化管理，建立了极速服务响应机制，资产客服经理常年7*24H在线，为客户提供资产充值提现等服务，保障客户在25分钟内完成资产充提。",
        aboutdesc4: "cbdcoincurrency(cbdcoincurrency)严格筛选优质项目并提供安全稳定的资产托管服务。cbdcoincurrency(cbdcoincurrency)秉承着“诚实、公正、热情、开放”的理念，竭力为用户打造安全、可靠、高效和友好的极致交易所。",
        ...
        apply: "上币申请",
        coop: "商务合作",
        community: "cbdcoincurrency社区",
        wechat: "微信",
        addwechat: "添加 “cbdcoincurrency01” 为微信好友，进入微信福利社群",
        weibo: "微博",
        twitter: "推特",
        biyong: "币用",
        telegram: "电报",
    ...
    bzb_description: {
        ...
        desc4: "参与cbdcoincurrency社区投票活动，包括但不限于上币、回购等",
    ...
    index: {
        ...
        BHBregister: "cbdcoincurrency账户注册",
        tibi: "提币到账时间及限额",
        line_plane: "BHB上线计划、流通量及手续费返还公告",
        fenpeijizhi: '关于cbdcoincurrency收入分配机制的说明',
        jiangli_jihua: "邀请挖矿奖励计划",
        friend_fanhuan: "邀请好友、赚取额外手续费返还"
    },
    plate: {
        title: "平台收入分配方案 (BHB 持有者权益)",
        content1: "正如白皮书所描述的，cbdcoincurrency会拿出平台的80% (扣除税费后) 的收入分配给cbdcoincurrency持有者，20%的收入用来支持平台的研发及运营。",
